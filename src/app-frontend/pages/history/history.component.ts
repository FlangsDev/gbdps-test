...
export class HistoryComponent {
  ...
  categories = [
    'Upload BC', 'Upload Scan', 'Good Receive', 'Good Issue',
  ...
  logs: ActivityLog[] = [
    ...
    { id: 2,  timestamp: new Date('2026-03-10T10:48:20'), user: 'Admin', action: 'Submit',   module: 'Good Receive',                detail: 'GR #GR-2026-0312 dicatat untuk Part QE54964',                      ipAddress: '192.168.1.10' },
    ...
    { id: 11, timestamp: new Date('2026-03-09T15:47:10'), user: 'Admin', action: 'Submit',   module: 'Good Receive',                detail: 'GR #GR-2026-0311 dicatat untuk Part B700C1AB',                    ipAddress: '192.168.1.10' },
